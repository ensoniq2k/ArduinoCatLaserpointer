...
#define LASER_SIDE_HARD_MIN 10
#define LASER_SIDE_HARD_MAX 170
#define LASER_FRONT_HARD_MIN 10
#define LASER_FRONT_HARD_MAX 17
#define MENU_LASER_LIMIT_STEP_FACTOR 5
#define MENU_SIDE_MAX (180 / MENU_LASER_LIMIT_STEP_FACTOR)
#define MENU_FRONT_MAX (180 / MENU_LASER_LIMIT_STEP_FACTOR)
